...
function mapPersonRow(person: any, tenantName?: string): Person {
  return {
    ...
    specifiedSkilledWorkerRemainingMonths: person.specified_skilled_worker_remaining_months,
    phone: person.phone,
...
export async function createPerson(person: Omit<Person, 'createdAt' | 'updatedAt'>): Promise<Person> {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      specified_skilled_worker_remaining_months: person.specifiedSkilledWorkerRemainingMonths,
      phone: person.phone,
...
export async function updatePerson(id: string, updates: Partial<Omit<Person, 'id' | 'createdAt' | 'updatedAt'>>): Promise<Person> {
  ...
  const { data, error } = await supabase
    ...
    .update({
      ...
      specified_skilled_worker_remaining_months: updates.specifiedSkilledWorkerRemainingMonths,
      phone: updates.phone,
